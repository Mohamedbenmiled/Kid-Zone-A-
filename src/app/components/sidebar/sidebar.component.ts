...
export const ROUTES: RouteInfo[] = [
    ...
    { path: '/reclamation', title: 'Reclamation',  icon:'ni-notification-70 text-black', class: '' },
    { path: '/rendezvous', title: 'Rendez Vous',  icon:'ni-calendar-grid-58 text-black', class: '' }
];
